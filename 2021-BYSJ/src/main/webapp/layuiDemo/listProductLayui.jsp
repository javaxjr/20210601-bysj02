    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function () {
        ...
        table.render({
            ...
            , cols: [[ //表头
                ...
                {field: 'count', title: '数量', sort: true, style: 'text-align:center', align: 'center'},
                {field: 'briefly', title: '简介', sort: true, style: 'text-align:center', align: 'center'},
                {field: 'details', title: '详情', sort: true, style: 'text-align:center', align: 'center'},
                {field: 'type', title: '类型', sort: true, style: 'text-align:center', align: 'center'},
