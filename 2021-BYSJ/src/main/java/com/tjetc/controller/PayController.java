...
public class PayController {
    ...
    private final String APP_ID = "2021000117663165";
    private final String APP_PRIVATE_KEY = "GAVeLEjv1Okbv/QWPzGUDg==";
    ...
    private final String NOTIFY_URL = "https://openapi.alipaydev.com/gateway.do";
    //支付宝同步通知路径,也就是当付款完毕后跳转本项目的页面,可以不是公网地址
    private final String RETURN_URL = "https://openapi.alipaydev.com/gateway.do";
